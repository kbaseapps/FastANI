...
function FastANI(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.fast_ani = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "FastANI.fast_ani",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "FastANI.status",
